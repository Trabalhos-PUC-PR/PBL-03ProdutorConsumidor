...
public class Manufacturer extends Thread {
	...
	public Manufacturer(String name, OrderQueue orderLine, ShipmentQueue shipmentQueue, Semaphore queueGate,
			Semaphore manufactureGate, Semaphore shipmentQueueGate, Semaphore transporterGate, int parallelCapacity) {
		this.name = name;
